...
const workspaces = ["components", "hooks", "utilities"];
  ...
  plop.setGenerator("component", {
    ...
    prompts: [
      ...
      },
      {
        type: "confirm",
        name: "forwardedRef",
        message: "Wrap component into forwardedRef",
      },
      {
        type: "list",
        name: "outDir",
    ...
    actions(answers) {
      ...
      const { componentName, description, forwardedRef, outDir } = answers;
      ...
      actions.push({
        ...
        base: "plop/component",
        data: { description, componentName, forwardedRef, outDir },
        abortOnFail: true,
      });
